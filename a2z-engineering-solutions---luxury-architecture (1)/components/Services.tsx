...
import { LayoutDashboard, Building2, Hammer, Ruler, ArrowRight } from 'lucide-react';
  ...
  const serviceData = [
    {
      ...
      description: "Luxury residential & commercial interiors crafted with precision, comfort, and timeless elegance."
    },
    {
      icon: <Building2 size={28} />,
      title: "Exterior Design",
      description: "Modern and classic exterior solutions that define architectural identity and durability."
    },
    {
      icon: <Hammer size={28} />,
      title: "Construction",
      description: "End-to-end construction services with quality materials, expert supervision, and on-time delivery."
    },
    {
      icon: <Ruler size={28} />,
      title: "Estimation & Planning",
      description: "Accurate cost estimation, planning, and execution strategies for hassle-free projects."
    }
  ];
    ...
    <section id="interior" className="relative py-24 md:py-40 bg-[#EEE9DF] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="text-center mb-20 md:mb-28">
          ...
          >
            Complete Interior, Exterior & Construction Solutions Under One Roof
          </motion.p>
        </div>
