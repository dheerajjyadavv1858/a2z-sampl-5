...
type ProjectCategory = 'All' | 'Interior' | 'Exterior' | 'Construction' | 'Commercial';
...
const categories: ProjectCategory[] = ['All', 'Interior', 'Exterior', 'Construction', 'Commercial'];
...
export const Portfolio: React.FC = () => {
  ...
  return (
    <section id="construction" className="relative py-24 md:py-40 bg-[#EEE9DF] overflow-hidden">
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 md:mb-24 gap-8">
          <div className="max-w-2xl">
            ...
            >
              Spaces We’ve Designed, Built & Transformed
            </motion.p>
          </div>
