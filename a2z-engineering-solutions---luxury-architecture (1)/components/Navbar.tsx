        ...
        >
          <div className="relative">
            <div className="w-10 h-10 border border-[#FFB162] flex items-center justify-center transform group-hover:rotate-45 transition-transform duration-500 bg-white/40">
              <span className="text-[#1B2632] font-display font-bold text-xl group-hover:-rotate-45 transition-transform duration-500">A</span>
            </div>
          </div>
          <div className="flex flex-col">
            <span className="text-xl font-display font-bold tracking-wider text-[#1B2632]">A2Z</span>
            <span className="text-[10px] uppercase tracking-[0.3em] text-[#2C3B4D]/60 -mt-1 font-semibold">Engineering Solutions</span>
          </div>
        </motion.div>

        {/* Desktop Links */}
        <div className="hidden lg:flex items-center space-x-10">
          {['Experience', 'Exterior', 'Interior', 'Construction', 'Estimators'].map((item) => (
            <a 
              key={item} 
