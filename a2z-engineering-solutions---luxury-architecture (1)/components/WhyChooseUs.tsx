  ...
  const uspPoints = [
    {
      ...
      description: "Over a decade of delivering quality-driven interior & construction projects across Lucknow."
    },
    {
    ...
    },
    {
      ...
      description: "From initial design to final execution, we handle everything seamlessly for a hassle-free experience."
    }
  ];
          ...
          <div className="space-y-12">
            ...
            >
              ...
              <h2 className="text-4xl md:text-6xl font-display font-bold text-[#1B2632] mb-6 leading-tight">
                ...
                <span className="text-gradient">A2Z Engineering</span>
              </h2>
            </motion.div>
