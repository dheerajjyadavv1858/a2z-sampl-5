...
const testimonialData: Testimonial[] = [
  {
    id: 1,
    text: "A2Z Engineering Solutions transformed our home beautifully. The design quality and execution were truly impressive. Every detail was handled with extreme precision.",
    author: "Rahul Sharma",
  ...
  {
    id: 2,
    text: "Professional team, transparent pricing, and timely delivery. Highly recommended for complex construction work in Lucknow. They know exactly how to manage large-scale projects.",
