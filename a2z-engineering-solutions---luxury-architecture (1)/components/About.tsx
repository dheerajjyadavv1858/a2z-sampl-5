...
export const About: React.FC = () => {
  ...
  const features = [
    ...
    { icon: <ShieldCheck size={20} />, text: "Residential & Commercial Projects" },
    { icon: <Users size={20} />, text: "Expert Engineers & Designers" },
    { icon: <Calculator size={20} />, text: "Transparent Cost Estimation" },
    { icon: <CheckCircle2 size={20} />, text: "Turnkey Interior & Construction" },
  ];
          ...
          <div className="lg:col-span-7 space-y-12">
            ...
            >
              ...
              <p className="text-xl text-[#A35139] font-display italic mb-8">
                "Where Engineering Meets Aesthetic Excellence"
              </p>
              <p className="text-[#2C3B4D]/70 text-lg leading-relaxed max-w-2xl font-medium">
                A2Z Engineering Solutions is a Lucknow-based interior, exterior, and construction firm with over 10 years of industry experience. We specialize in transforming spaces into elegant, functional, and timeless environments.
              </p>
            </motion.div>
